...
#     # We'll also generate sellers simple list here so FK satisfied
#     num_sellers = 10
...
#     # --- 6️⃣ order_reviews (some orders only) ---
#     review_rows = []
...
#     # --- Convert pandas -> polars (insert_output expects polars DataFrame) ---
...
#     # --- 6️⃣ Insert theo đúng thứ tự ràng buộc ---
#     mysql = context.resources.mysql_io_manager

#     # create a tiny dummy context object that has .metadata and .log (insert_output expects context with metadata)
#     class _DummyCtx:
...
#         value=None,
#         metadata={
#             "customers": customers_pd.shape,
#             "sellers": sellers_pd.shape,
#             "products": products_pd.shape,
#             "orders": orders_pd.shape,
#             "order_items": order_items_pd.shape,
#             "payments": payments_pd.shape,
#             "order_reviews": order_reviews_pd.shape,
#         },
#     )
